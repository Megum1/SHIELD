...
## Overview
- This is the PyTorch implementation for NeurIPS 2025 Workshop (*the 1st GenProCC*) paper "[SHIELD: A Benchmark Study on Zero-Shot Detection of AI-Edited Images with Vision Language Models](assets/camera_ready.pdf)".
